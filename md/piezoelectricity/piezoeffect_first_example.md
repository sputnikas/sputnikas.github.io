## Пьезоэлектрическая бесконечная пластина на неподвижной подложке в воздушной среде
...
$$
\arg A = - \arctg \frac{\dfrac{v'\rho'}{v \rho} \tg (kl)}{1 - \left(1 -\dfrac{V^2}{v^2}\right) \dfrac{\tg (kl)}{kl}}
$$
...
<div style="text-align:center"><img src="./piezoeffect_first_example_1.png"></div>
