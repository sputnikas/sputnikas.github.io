...
Сложнее всё будет с уравнениями движения и уравнениями непрерывности. Особенность в том, что один тип частиц ("движущихся туда") при определённых условиях переходит в другой тип частиц ("движущихся обратно"). Этот факт, а главное точный вид зависимости одних функций от других необходимо как-то учесть. Вариант заключается в том, чтобы ввести некоторые функции 

$$Q_+(\tilde{\rho}_+, \vec{u}_+, \gamma_+) $$ 

и 

$$ Q_-(\tilde{\rho}_-, \vec{u}_-, \gamma_-)$$

которые имели бы смысл числа частиц в единицах $\tilde{\rho}$ в единицу времени, переходящих в другую группу. Тогда:
